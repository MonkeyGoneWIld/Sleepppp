...
class State:
    ...
    tokenApi = 'https://jolly-cell-f91c.osama-a-k-1995.workers.dev/api/client/v2/token'
    dedicatedIpApi = 'https://jolly-cell-f91c.osama-a-k-1995.workers.dev/api/client/v2/dedicated_ip'
    token = ''
